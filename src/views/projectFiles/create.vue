...
<script>
  import { selectProject,saveInsert,getUserList,getUserListByExample } from '../../api/projectFiles'
  export default {
    name: 'Create',
    data () {
      return {
    ...
    methods: {
      ...
      ProjectChangeAdd() {
        this.projectChanges = { id: '', projectId: '', reason: '', memo: '', time: '', type: '', username: ''}
        this.value1=''
