...
<!--          <el-input v-model="list.preTaskName"/>-->
<!--        </el-form-item>-->
<!--        <el-form-item label="下级任务" prop="nextTaskName">-->
<!--          <el-input v-model="list.nextTaskName"/>-->
<!--        </el-form-item>-->
      ...
      <el-form  ref="list"  :model="list" label-width="100px">
        <el-form-item label="任务" prop="tTask">
          <el-input   type="textarea"
                      ...
                      maxlength="150"
                      show-word-limit
                      placeholder="请输入任务具体内容" v-model="list.tTask"/>
        </el-form-item>
      </el-form>
    </el-card>
    <el-card class="box-card">
...
<!--        <el-table-column align="center" label="结束时间" prop="endtime" />-->
      ...
      <el-dialog :visible.sync="editVisiable" title="编辑任务成员">
        <el-form ref="attributeForm" :model="projectTaskResources" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
...
<script>
  import { selectTask,getUserListByExample,getAllProject,saveTasksUpdate,getUserList } from '../../api/taskSheet'
  export default {
    name: 'Edit',
    data () {
      return {
    ...
    methods: {
      ...
      handleSpecificationShow() {
        this.projectTaskResources = {     id: '', projectTaskId: '', userId: '', receiveUser: '', memo: '', time: '' ,endtime: ''}
      ...
      handleEdit: function() {
        ...
        saveTasksUpdate(t).then(response => {
